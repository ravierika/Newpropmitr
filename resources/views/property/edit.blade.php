            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ route('properties.update', $property->id) }}" files="true" enctype="multipart/form-data">
                            @method('PATCH') 
                            @csrf
                            ...
                            <div class="row clearfix mt-3">
                                <div class="col-sm-6">
                                    <div class="radio inlineblock m-r-45">
                                        <input type="radio" class="form-control" name="for" id="radio1" value="sale" {{ $property->for == 'sale' ? 'checked' : '' }}>
                                        <label for="radio1">For Sale</label>
                                    </div>
                                    <div class="radio inlineblock m-r-45">
                                        <input type="radio" class="form-control" name="for" id="radio2" value="rent" {{ $property->for == 'rent' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <select name="type" class="form-control show-tick ms select2" data-placeholder="Select">
                                            ...
                                            <optgroup label="Residential">
                                                <option value="FA" {{ $property->type == 'FA' ? 'selected' : '' }}>Flat/Apartment </option>
                                            ...
                                            <optgroup label="Commercial">
                                                ...
                                                <option value="IL" {{ $property->type == 'IL' ? 'selected' : '' }}>Industrial Land</option>
                            ...
                            <div class="row clearfix mt-3">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control" name="city" value="{{$property->city}}" id="city" placeholder="Enter City">                                </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input class="form-control" name="locality" value="{{$property->locality}}" id="locality" placeholder="Enter Locality">
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="1" name="address" class="form-control no-resize" placeholder="Please type the Address">{{$property->address}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>        
                            ...
                            <div class="row mt-3">
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="carpetArea" value="{{$property->carpetArea}}" class="form-control" placeholder="Carpet Area">
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="superArea" value="{{$property->superArea}}" class="form-control" placeholder="Super Area">
                            ...
                            <div class="row clearfix mt-3">
                                <div class="col-sm-6">
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" name="availability" class="custom-control-input sssss" id="radio4" value="rtm" {{ $property->availability == 'rtm' ? 'checked' : '' }}>
                                        <label for="radio4">Ready to Move</label>
                                    </div>
                                    <div class="radio inlineblock m-r-25">
                                        <input type="radio" name="availability" class="custom-control-input sssss" id="radio5" value="UC" {{ $property->availability == 'UC' ? 'checked' : '' }}>
                            ...
                            <div class="row clearfix mt-3">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="expectedPrice" value="{{$property->expectedPrice}}" class="form-control" placeholder="Expected Price">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="tokenMoney" class="form-control" value="{{$property->tokenMoney}}" placeholder="Token Amount">
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <textarea rows="1"  name="description"  class="form-control no-resize" placeholder="Please type some description to highlight your property">{{$property->description}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>        
