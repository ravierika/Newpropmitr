    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Hotels</strong> Information <small></small> </h2>
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="hotel w-100 row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="d-flex align-items-center" for="portal"><span class="red ml-3">*</span> <span>Source/Portal</span></label>
                                        <input id="portal" type="text" name="portal" class="form-control @error('rooms') is-invalid @enderror" placeholder="Source/Portal" required autocomplete="portal" value="{{ old('portal') }}">
                                        @error('portal')
                                        <span class="invalid-feedback" role="alert" id="portalError">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label class="d-flex align-items-center" for="hotelVpucher"><span class="red ml-3">*</span> <span>Upload hotel voucher</span></label>
                                        <input id="hotelVpucher" type="file" name="hotelVpucher" class="form-control @error('rooms') is-invalid @enderror" placeholder="Upload hotel voucher" required autocomplete="hotelVpucher" value="{{ old('hotelVpucher') }}">
                                        @error('hotelVpucher')
                                        <span class="invalid-feedback" role="alert" id="hotelVpucherError">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                        @enderror
                                    </div>
